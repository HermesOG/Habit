...
(function () {
  ...
  /* 1→2 стоит 8 XP = ровно одна отметка привычки обычной сложности: первая искра в онбординге
     сразу поднимает на 2-й уровень, и Хранитель открывает глаза в той же сессии. */
  var EARLY = [8, 15, 20, 25, 30, 40, 45, 50, 55];
  function need(n) {
